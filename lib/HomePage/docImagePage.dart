  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: Text(widget.docName,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
      ),
                          ...
                          child: ClipRRect(
                            ...
                            child: const Center(
                              child: Row(
                                ...
                                children: [
                                  Text('Add Document',style: TextStyle(fontSize: 17),),
                                  SizedBox(width: 10,),
                      ...
                      SizedBox(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Text("Document updated?",style: TextStyle(fontSize: 15,),),
                              GestureDetector(
                                onTap: (){},
                                child: Container(
                                  height: 30,
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: const Icon(Icons.photo_rounded,size: 18,color: Colors.white,),
                                ),
                              ),
                              GestureDetector(
                                onTap: (){},
